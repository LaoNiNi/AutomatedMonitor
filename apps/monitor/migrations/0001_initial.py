# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-04-09 10:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('recover_subject', models.CharField(blank=True, max_length=128, null=True, verbose_name='通知主题')),
        ...
        migrations.AddField(
            model_name='eventlog',
            name='host',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='monitor.Host', verbose_name='Host'),
        ),
        migrations.AddField(
            model_name='eventlog',
            name='trigger',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='monitor.Trigger', verbose_name='Trigger'),
        ),
        migrations.AddField(
            model_name='action',
            name='host_groups',
